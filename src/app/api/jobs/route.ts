...
/**
 * GET /api/jobs
 * Fetch job listings with all required fields
 * Supports query parameter: ?q=searchQuery
 */
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    // Return job data with all required fields
    ...
    console.error("Get jobs error:", error instanceof Error ? error.message : "Unknown error");
